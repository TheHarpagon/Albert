...
class Events(commands.Cog):
  ...
  async def on_message_delete(self, message):
    if message.author.bot == False and self.bot.memberRole in message.author.roles and message.channel.id not in [690647361139245136, 816540206572109824, 835694338230452228] and not message.content.startswith(":") and not message.content.endswith(":"):
